...
public class KafkaConfiguration {
    ...
    public NewTopic inventoryCreatedMessageTopic() {
        return new NewTopic("create-inventory", 1, (short) 1);
    }

    @Bean
    public KafkaTemplate<String, CreateInventoryEvent> messagePaymentKafkaTemplate() {
        return new KafkaTemplate<String, CreateInventoryEvent>(messageProducerFactory());
    }
